...
For CSS patterns, implementation templates, and fixes for common customization issues, see:

**`fixes.md`**

This file contains:
- CSS specificity patterns for overriding base.css
- Implementation templates for block customizations
- Debugging steps for settings not applying
- Existing block implementation references
